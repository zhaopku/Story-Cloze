...
class Model_satt:
    ...
    def buildRNN(self):
        ...
        with tf.variable_scope('sentence_attention', reuse=tf.AUTO_REUSE):
            ...
            # [batchSize, (nSentences-2)*hiddenSize*2]
            context_vec = tf.reshape(context_vec, shape=[-1, (self.args.nSentences-2)*self.args.hiddenSize*2], name='context_vec')
            ...
            context_vec = utils.ffnn(inputs=context_vec, num_hidden_layers=self.args.pffnnLayers, hidden_size=self.args.pffnnSize,
                                 output_size=self.args.hiddenSize*2, dropout=self.dropOutRate)
